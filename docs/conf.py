...
from litestar_zstd.__metadata__ import __project__ as project
from litestar_zstd.__metadata__ import __version__ as version
...
author = "Julien Courtès"
release = version
release = os.getenv("_LITESTAR-ZSTD_DOCS_BUILD_VERSION", version.rsplit(".")[0])
copyright = "2023, Julien Courtès"  # noqa: A001
...
html_theme_options = {
    ...
    "github_url": "https://github.com/kumzy/litestar-zstd",
    "nav_links": [
        {"title": "Home", "url": "https://kumzy.github.io/litesatr-zstd/"},
        {"title": "Docs", "url": "https://kumzy.github.io/litesatr-zstd/latest/"},
        {"title": "Code", "url": "https://github.com/kumzy/litestar-zstd"},
    ],
    "light_css_variables": {
        # RGB
